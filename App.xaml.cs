...
namespace SonicLairXbox
{
    ...
    sealed partial class App : Application, INotifier
    {
        ...
        public App()
        {
            ...
            _backgroundAudio = new BackgroundAudioService(musicService, Container.GetService<ISubsonicService>());
        }
        // Keeps SMTC (and therefore background audio) wired up for the app's lifetime.
        private readonly BackgroundAudioService _backgroundAudio;
